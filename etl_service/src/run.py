...
if __name__ == "__main__":
    ...
    - UserGenerateContentETLScheduler: ETL-обработчиков для сервиса генерации контента пользователем (UGS).

    """
    current_loop = asyncio.get_event_loop()

    current_loop.run_until_complete(MoviesETLScheduler.run())
    # current_loop.run_until_complete(UserGenerateContentETLScheduler.run())
