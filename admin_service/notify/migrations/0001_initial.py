# Generated by Django 5.0.4 on 2025-06-06 01:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, help_text='Title of the message', max_length=255, null=True, verbose_name='Message title')),
                ('body', models.TextField(help_text='Text of the message (HTML or plain text)', verbose_name='Message body')),
                ('url', models.URLField(blank=True, help_text='Optional link that can be included in the message', null=True, verbose_name='Message url')),
                ('user_ids', models.TextField(blank=True, help_text='UUIDs of users separated by commas, without spaces', verbose_name='User IDs')),
                ...
                ('execution_at', models.DateTimeField(default=datetime.datetime(2025, 6, 6, 1, 27, 39, 542520, tzinfo=datetime.timezone.utc), help_text='When the Notify_worker should process this message', verbose_name='Execution at (date/time)')),
